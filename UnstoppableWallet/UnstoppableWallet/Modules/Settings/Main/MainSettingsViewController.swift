...
class MainSettingsViewController: ThemeViewController {
    ...
    private func openTelegram() {
        ...
        //if let appUrl = URL(string: "tg://resolve?domain=\(account)"),
        if let appUrl = URL(string: "https://t.me/top50cryptochannels"),
           UIApplication.shared.canOpenURL(appUrl) {
            UIApplication.shared.open(appUrl)
       // } else if let webUrl = URL(string: "https://t.me/\(account)") {
        } else if let webUrl = URL(string: "https://t.me/top50cryptochannels") {
